            ...
            <div class="form-group">
                ...
                <select class="form-control select2 select2-hidden-accessible" id="type" name="type" style="width: 100%;" tabindex="-1" aria-hidden="true" required>
                    ...
                    <?php if($check['type'] == "callback") { ?>
                        <option value='unsuccessful' <?php if($alert['type'] == "unsuccessful") echo "selected"; ?>><?php _e('Unsuccessful'); ?></option>
                    <?php } ?>
...
<script type="text/javascript">
    ...
    <?php if($alert['type'] == "offline" || $alert['type'] == "blacklist" || $alert['type'] == "dns" || $alert['type'] == "unsuccessful") { ?>
