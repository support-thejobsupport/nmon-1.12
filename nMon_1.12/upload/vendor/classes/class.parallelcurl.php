...
class ParallelCurl {
    ...
    public function startRequest($url, $websiteid, $expect, $callback, $user_data = array(), $post_fields=null) {
	...
	while ($active && $mrc == CURLM_OK) {
        ...
        while ($info = curl_multi_info_read($this->multi_handle)) {
            ...
            call_user_func($callback, $content, $url, $websiteid, $expect, $ch, $user_data);
